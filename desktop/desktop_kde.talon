...
[tile] float: key(super-f)
title main: key(alt-super-shift-/)

(desk | desktop) 1: key(ctrl-f1)
(desk | desktop) 2: key(ctrl-f2)
(desk | desktop) 3: key(ctrl-f3)
(desk | desktop) 4: key(ctrl-f4)
